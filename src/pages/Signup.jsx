...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-sky-100 to-blue-200 overflow-x-hidden">
      {/* Header */}
          ...
          <Card className="border-sky-300 shadow-xl bg-white">
            ...
            <CardContent className="space-y-4 pt-6">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-sky-800 flex">
                  Name
                </Label>
                <Input
                  id="name"
              ...
              {/* Role Selection */}
              <div className="space-y-2">
                <Label className="text-sky-800 flex">Select Role</Label>
                <div className="flex gap-4">
                  {[
                    { value: "ADMIN", label: "Admin" },
                    { value: "QUIZ_CREATOR", label: "Teacher" },
                    { value: "USER", label: "Student" },
                  ].map((roleOption) => (
                    <label
                      key={roleOption.value}
                      className="flex items-center space-x-2 text-sky-700"
                    >
                      <input
                        type="radio"
                        name="role"
