...
const TopicDetail: React.FC = () => {
  ...
  return (
    <div className="container py-8 max-w-4xl">
      ...
      >
        <Card
          className={`bg-gradient-to-br ${config.gradient} rounded-lg border border-gray-200 shadow-md hover:shadow-lg transition-all`}
        >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <AnimatePresence>
                  {topic.subtopics.map((subtopic, index) => (
                    ...
                    >
                      <Card
                        className={`bg-white rounded-lg border border-gray-200 hover:scale-105 hover:shadow-lg hover:border-${
